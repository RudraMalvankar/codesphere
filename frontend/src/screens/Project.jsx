...
const Project = () => {
    ...
    //     const messsageBox = document.querySelector('.message-box')

    //     const message = document.createElement('div')
    //     message.className.add('message', 'max-w-56','flex', 'flex-col', 'p-2', 'bg-slate-50', 'w-fit', 'rounded-md')
    //     message.innerHTML = `<p>${messageObject.message}</p>`
